...
EntityPlayer = ig.Entity.extend({
	...
	animSheet: new ig.AnimationSheet( 'media/Royal_wave_sketch_walk_animatio.png', 52, 120  ),	
	...
	init: function( x, y, settings ) {
        ...
        if( !ig.global.wm )    {
            ...
            ig.game.events.on("wave", function(){
                console.log("shoot!");
                ig.game.spawnEntity( EntityFireball,self.pos.x, self.pos.y+40, {flip:self.flip} );
            });
        }
